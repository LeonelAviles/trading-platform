  ...
  return (
    <g>
      ...
      {selected && canInteract && (
        <>
          <circle cx={p1.x} cy={p1.y} r={5} fill="#0a0a0c" stroke={color} pointerEvents="all" strokeWidth={1.5} style={{ cursor: 'crosshair' }}
            onPointerDown={h1Drag.onPointerDown} onPointerMove={(e) => h1Drag.onPointerMove(e, setShapes)} onPointerUp={h1Drag.onPointerUp} />
          <circle cx={p2.x} cy={p2.y} r={5} fill="#0a0a0c" stroke={color} pointerEvents="all" strokeWidth={1.5} style={{ cursor: 'crosshair' }}
