...
const I = {
  ...
  chart: <svg viewBox="0 0 24 24"><path d="M7 4v4M7 16v4M7 8h-2v8h2zM7 8h2v8H7zM17 3v3M17 15v6M17 6h-2v9h2zM17 6h2v9h-2zM12 9v2M12 17v3M12 11h-2v6h2zM12 11h2v6h-2z" /></svg>,
...
const NAV = [
  ...
  { to: '/chart/ES1!', label: 'Chart & replay', icon: 'chart', match: ['/chart'], hint: 'Tick replay, order flow layers' },
