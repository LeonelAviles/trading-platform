...
Revision ID: ee6a4a034450
Revises: 
Create Date: 2026-08-16 20:48:38.716078
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_market_data_source_id'), 'market_data', ['source_id'], unique=False)
    ...
    op.create_index(op.f('ix_bars_market_data_id'), 'bars', ['market_data_id'], unique=False)
    ...
    op.create_index(op.f('ix_ticks_market_data_id'), 'ticks', ['market_data_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_ticks_market_data_id'), table_name='ticks')
    op.drop_table('ticks')
    ...
    op.drop_index(op.f('ix_bars_market_data_id'), table_name='bars')
    op.drop_table('bars')
    ...
    op.drop_index(op.f('ix_market_data_source_id'), table_name='market_data')
